...
<qgis simplifyDrawingTol="2" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Labeling|Rendering|CustomProperties" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyDrawingHints="0" minScale="100000000" readOnly="0" symbologyReferenceScale="-1" maxScale="0" version="3.22.0-Białowieża" labelsEnabled="0" simplifyAlgorithm="0">
  <flags>
  ...
  <renderer-v2 referencescale="-1" type="categorizedSymbol" attr="type" enableorderby="0" forceraster="0" symbollevels="0">
    <categories>
      <category symbol="0" label="железо" render="true" value="железо"/>
      <category symbol="1" label="рыболовные снасти" render="true" value="рыболовные снасти"/>
      <category symbol="2" label="пластик" render="true" value="пластик"/>
      <category symbol="3" label="дерево" render="true" value="дерево"/>
      <category symbol="4" label="бетон" render="true" value="бетон"/>
      <category symbol="5" label="резина" render="true" value="резина"/>
      <category symbol="6" label="" render="false" value=""/>
    </categories>
    <symbols>
